...
class InfoPage:
    ...
    def enter_your_details(self):
        self._driver.find_element(By.CSS_SELECTOR, self.first_name_locator).send_keys("Ivan")
        self._driver.find_element(By.CSS_SELECTOR, self.last_name_locator).send_keys("Ivanov")
        self._driver.find_element(By.CSS_SELECTOR, self.zip_code_locator).send_keys("123456")
